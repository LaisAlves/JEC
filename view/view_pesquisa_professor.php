...
echo "<td><a class=btn btn-outline-success  href =../ProfessorController.php?acao=excluir&id=".$escrever['idPROFESSORES'].">Excluir</a></td>";

echo "  <td>
  <form action=view_editar_professor.php?id=".$escrever['idPROFESSORES']." method=post>
                 <input name=nome  type=hidden value=" .$escrever['NOME'].">
                 <input name=email type=hidden value=" .$escrever['EMAIL']. ">
				 <input name=senha type=hidden value=" .$escrever['SENHA']. ">
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <a href= "../manter_professor.php" class="btn btn-primary"> Adicionar Professor </a>
