...
// PEGAR DADOS DO CENARIO DE ACORDO COM UM ID
 ...
 // $cenarioDao = new CenarioDao();
  //$dadosCenario = $cenarioDao->retornaCenario($id);
			...
			/*
            $nomePort = filter_input(INPUT_POST, 'nomePort');
			
            $nomeIng = filter_input(INPUT_POST, 'nomeIng');
...
echo "<form class= form-horizontal method=post action=../EmpresaController.php?acao=manterEmpresaEditar&id=".$id;
echo ">"
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="idNomeEmpresa" name="idNomeEmpresa" value = "<?php echo $nome ?>" type="text"  class="form-control input-md" required="">
