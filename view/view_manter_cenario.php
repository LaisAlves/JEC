...
<form class="form-horizontal"method="post" action="CenarioController.php?acao=manterCenario">
<fieldset>
<br><br>
<div class="container">
<!-- Form Name -->
...
<div class="form-group">
  <label class="col-md-4 control-label" for="idNomeCenario">Nome do Cenário em Português</label>  
  <div class="col-md-5">
  <input id="cenarioPort" name="cenarioPort" type="text" placeholder="Nome do Cenario" class="form-control input-md" required="">
